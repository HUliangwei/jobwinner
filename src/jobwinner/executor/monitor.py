...
from jobwinner.browser import new_tab, close_tab, evaluate, click, wait_for_load, get_page_info
from jobwinner.cancellation import (
    OperationCancelled,
    get_stop_event,
    run_cancellable,
    stop_requested,
...
def _handle_conversation(job: dict, config: dict) -> str:
    ...
    if _detect_resume_request(messages):
        ...
        from jobwinner.ai.resume import generate_tailored_resume, get_last_resume_failure_reason
