"""Browser facade backed by JobWinner's built-in Browser Runtime."""
...
from jobwinner.browser.client import RuntimeClient
from jobwinner.browser.runtime import ensure_runtime, get_runtime_url, set_browser_config
