...
import { BriefcaseBusiness, Github, Kanban, LayoutDashboard, LogIn, Radar, Settings } from 'lucide-react'
...
const navItems = [
  ...
  { to: '/login', icon: LogIn, label: '登录管理' },
  { to: '/config', icon: Settings, label: '配置' },
]

const GITHUB_URL = 'https://github.com/HUliangwei/jobwinner'
      ...
      <div className="h-16 flex items-center px-5 border-b border-card-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-[11px] text-muted">v2.4 · 本地控制台</div>
          </div>
        </div>
      </div>
